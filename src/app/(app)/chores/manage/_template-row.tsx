...
/**
 * Chore template row — display + simple edit (title/points/assignee) + delete.
 *
  ...
  return (
    ...
    >
      ...
      <Input
        ...
        placeholder={t("chores.title_label")}
        required
      />
