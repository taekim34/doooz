...
export function CreateTaskForm({ childrenList, todayLocal, createAction }: Props) {
  ...
  return (
    <form action={onSubmit} className="space-y-4">
      {/* Title */}
      <div>
        <label className="mb-1 block text-sm font-medium">{t("tasks.title_label")}</label>
        <Input
          value={title}
      ...
      {/* Points quick-pick */}
      <div>
        <label className="mb-1 block text-sm font-medium">{t("tasks.points_label")}</label>
      ...
      <div>
        <label className="mb-1 block text-sm font-medium">{t("tasks.assignee_label")}</label>
        {hasChildren ? (
          <select
            value={assigneeId}
      ...
      {/* Recurrence */}
      <div>
        <label className="mb-1 block text-sm font-medium">{t("tasks.recurrence_label")}</label>
